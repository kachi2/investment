...
class UserAccountController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        return response()->json(["msg" => __('Your Crypto account successfully added.'), "msg_title" => __('Account Added')]);
    }
    ...
    public function update($hash, Request $request)
    {
        ...
        return response()->json(["reload" => 1500, "msg" => __('The Crypto account successfully updated.'), "msg_title" => __('Account Updated')]);
    }
