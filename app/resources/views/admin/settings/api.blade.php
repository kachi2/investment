                            ...
                            <div class="col-lg-5">
                                <div class="form-group">
                                    ...
                                    <span class="form-note">
                                    	...
                                    	{!! __("If you don't have, get your API from :external website.", ['external' => '<a href="https://www.tawk.to/" target="_blank">Tawk.to</a>']) !!}
                                    </span>
                                </div>
                            </div>
                            <div class="col-lg-7">
                        ...
                        <div class="row g-3 align-start">
                            ...
                            <div class="col-lg-7">
                                <div class="form-group">
                                    ...
                                    <div class="form-note">
                                    	<strong>{{ __('reCaptcha Site Key') }}</strong>
                                    </div>
                                    ...
                                    <div class="form-note">
                                    	<strong>{{ __('reCaptcha Secret Key') }}</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
