                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap w-150px">
                                        <select class="form-select" name="limit_request">
                                            @for($i=0; $i <=10; $i++)
                                                <option value="{{ $i }}"{{ (sys_settings('deposit_limit_request', 0)==$i) ? ' selected' : '' }}>{{ ($i==0) ? 'No' : sprintf('%02s', $i) }}</option>
                                            @endfor
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap w-150px">
                                        <select class="form-select" name="cancel_timeout">
                                            ...
                                            @for($i=0; $i <=12; $i++)
                                            <option value="{{ ($i * 5) }}"{{ (sys_settings('deposit_cancel_timeout', 15)===($i * 5)) ? ' selected' : '' }}>{{ ($i==0) ? 'No' : ($i * 5).' Min' }}</option>
                                            @endfor
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    <div class="form-control-wrap w-150px">
                                        <select class="form-select" name="limit_request">
                                            @for($i=0; $i <=10; $i++)
                                                <option value="{{ $i }}"{{ (sys_settings('withdraw_limit_request', 0)==$i) ? ' selected' : '' }}>{{ ($i==0) ? 'No' : sprintf('%02s', $i) }}</option>
                                            @endfor
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap w-150px">
                                        <select class="form-select" name="cancel_timeout">
                                            ...
                                            @for($i=0; $i <=12; $i++)
                                            <option value="{{ ($i * 5) }}"{{ (sys_settings('withdraw_cancel_timeout', 15)===($i * 5)) ? ' selected' : '' }}>{{ ($i==0) ? 'No' : ($i * 5).' Min' }}</option>
                                            @endfor
                                        </select>
                                    </div>
                                </div>
