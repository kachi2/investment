                                ...
                                <ul class="list-inline mb-0 contact-detail float-end">                                                   
                                    <li class="list-inline-item">
                                        <div class="ps-3">
                                            ...
                                            <p class="text-muted mb-0">https://theadventcapital.com</p>
                                            <p class="text-muted mb-0">billing@theadventcapital.com</p>
                                        </div>                                                
                                    </li>
                                    <li class="list-inline-item">
                                        <div class="ps-3">
                                    ...
                                    <li class="list-inline-item">
                                        <div class="ps-3">
                                            ...
                                            <p class="text-muted mb-0"> @if($salary->is_approved == 1)<span class="btn btn-success">Invoice Paid</span>  @elseif($salary->is_approved == 0) <span class="btn btn-info">Invoice Pending</span> @else  <span class="btn btn-danger">Invoice Cancelled</span> @endif</p>
                                        </div>
                                    </li>
                                </ul>
                            </div><!--end col-->    
                                    ...
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>                                                        
                                                ...
                                                <td class="border-0 font-14 text-dark"><b>{{$salary->amount}}</b></td>
                                            </tr><!--end tr-->
                                            <tr>
