                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <ul class="nav-border nav nav-pills" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active fw-semibold" data-bs-toggle="tab" href="#Register_Tab" role="tab">Hello {{$agent->name}}, Complete your Account Registration to access your Adventcap Agency Portal</a>
                                    </li>
                                </ul>
                                 <!-- Tab panes -->
