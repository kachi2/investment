...
<section id="slider" style="height: 700px;" class="section slider-area">
    <div class="container text-center">
        ...
        <div class="intro-text clearfix">
            <h2 style="color: #fff;">Adventcap a Trading company You Can Trust</h2>
            <p>Adventcap Limited is a highly trusted crypto Trading comapany, helping millions of individuals and firms across the globe to safely Trade and earn more with crypto currency.</p>
            <div class="btn-set">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="about-content">
                    ...
                    <p>Adventcap Limited As a client- oriented company, we embrace the needs of the traders whom expect and demand tight spread, fast execution, and Transparency of operation.</p><br>
                    <p>
                    ...
                    <a href="https://live.theadventcapital.com" class="btn">Join Now</a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="feature-box">
                    ...
                    <div class="feature-content">
                        <h3>Our Values</h3>
                        <p>At Adventcap Limited, we belive that everyone should have an unmetered access to explore the wonderful world of crypto with all of its benefits.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="section-title">
                    ...
                    <p>         Round-the-Clock Support.
                        ...
                        <p>
                        Trade with Adventcap at low costs.
                        We have received high customer satisfaction, among other things also thanks to the favorable Trading conditions..
                        The large product variety of Adventcap offers countless possibilities on the markets worldwide </p>
                </div>
            </div>
        </div>        
        ...
        <div class="row hr-center">
            ...
            <div class="col-md-4 col-sm-8">
                <div class="video-text">
                    <h4>Learn more about Adventcap</h4>
