                        ...
                        <div class="nk-ivp-summary card-text">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <span class="sub-text">{{ __(':period Interest', [ 'period' => ucfirst(data_get($ivp, 'calc_period'))]) }}</span>
                                </div>
                                <div class="col-6">
                                    <span class="lead-text"><span class="small text-dark">{{ data_get($ivp, 'term') }}</span></span>
                                    <span class="sub-text">{{ __('Term :type',['type' => ucfirst(data_get($ivp, 'term_type'))]) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
