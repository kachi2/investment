    ...
    <div class="modal-content">
        ...
        <div class="modal-body modal-body-md">
            ...
            <div class="nk-block">
                <div class="progress-wrap">
                    ...
                    <div class="progress-text pt-1">
                        ...
                        <div class="progress-amount"><span class="pup-count">0</span> / <span class="total">{{ count($accounts) }}</span></div>
                    </div>
                ...
                <ul class="align-center flex-nowrap mt-4 pb-2 pt-1">
                    <li>
                        <button type="button" class="btn btn-primary m-ivs-sync" data-method="profits">{{ __('Paid the Profits') }}</button>
                    </li>
                </ul>
            ...
            <script type="text/javascript">
                var bulkpq = { queues: @json($accounts), total: {{ count($accounts) }}, batch: {{ count($accounts) }}, url: "{{ route('admin.investment.process.profits.payout') }}" };
            </script>
        </div>
    </div>
</div>
