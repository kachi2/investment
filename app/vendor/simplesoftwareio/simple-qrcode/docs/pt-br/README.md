...
>Quanto maior a correção de erros utilizada, maior o QrCode fica e menos informação ele pode arAdventcapnar. Leia mais sobre [correção de erros](http://en.wikipedia.org/wiki/QR_code#Error_correction).
