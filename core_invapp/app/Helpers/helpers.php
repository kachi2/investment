...
if (!function_exists("str_sub_count")) {
     ...
     * @since 1.0
     */
    function str_sub_count($str = null, $len = 11)
    {
...
if (!function_exists('get_ex_rate')) {
    ...
    function get_ex_rate($code, $amount = 1, $flush = false)
    {
        ...
        $rate = ($fx_rate) ? ($fx_rate * $amount) : (1 * $amount);
...
if (!function_exists('remainingTimeout')) {
...
if (!function_exists('is_locked')) {
     ...
     * @return boolean
     */
    function is_locked($type, $prefix = '')
    {   
        ...
        if ($gss == null) {
            ...
            return !now()->greaterThan(Carbon::parse($gss)->addMinutes(5));
        }
