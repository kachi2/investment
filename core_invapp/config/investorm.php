...
return [
    'uid_prefix' => env('UID_PREFIX', 'UID'),
    'tnx_prefix' => env('TNX_PREFIX', 'TNX'),
    'ivx_prefix' => env('IVX_PREFIX', 'IVX'),
    'inv_prefix' => env('INV_PREFIX', 'INV'),
    'pgtn_pr_pg' => [10, 20, 50],
    'pgtn_dnsty' => ['regular', 'compact'],
    'pgtn_order' => ['asc', 'desc'],
    'pgtn_sort_pg' => ['date', 'visible'],
    'timezones' => [
