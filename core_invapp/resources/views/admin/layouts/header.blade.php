                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li><a href="{{ route('admin.profile.view') }}"><em
                                                class="icon ni ni-user-alt"></em><span>{{ __('View Profile') }}</span></a>
                                    </li>
                                    <li><a href="{{ route('admin.profile.view', ['settings']) }}"><em
                                                class="icon ni ni-setting-alt"></em><span>{{ __('Account Setting') }}</span></a>
                                    </li>
                                    <li><a href="{{ route('admin.profile.view', ['activity']) }}"><em
                                                class="icon ni ni-activity-alt"></em><span>{{ __('Login Activity') }}</span></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="dropdown-inner">
