    ...
    <div class="container-fluid">
        ...
        <div class="pb-4">
            <ul class="nav-border nav nav-pills mb-0" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="Profile_Post_tab" data-bs-toggle="pill" href="#Profile_Post">Update Account</a>
                </li>
                                    ...
                                    <div class="card-body">                       
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-8">
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="las la"></i></span>
                                                    <input type="email" class="form-control" name="address" value="{{agent_user()->city}}" placeholder="Email" aria-describedby="basic-addon1" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-8">
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="las la"></i></span>
                                                    <input type="email" class="form-control" name="state" value="{{agent_user()->state}}" placeholder="Email" aria-describedby="basic-addon1" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-8">
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="las la"></i></span>
                                                    <input type="email" class="form-control" name="country" value="{{agent_user()->country}}" placeholder="Email" aria-describedby="basic-addon1" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-8">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control" name="payment_method">
                                                        @if(agent_user()->payment_method)<option value="{{agent_user()->payment_method}}">{{agent_user()->payment_method}}</option>
                                                        @else
