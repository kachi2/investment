# Nio Laravel Installer | A Web Installer [Package](https://packagist.org/packages/softnio/laravel-installer)
...
* [Laravel 5.1 - 5.8+](https://laravel.com/docs/installation)
...
```php
	'providers' => [
	    Softnio\LaravelInstaller\Providers\LaravelInstallerServiceProvider::class,
	];
```
